...
def main():
    ...
    mask = memes.qwen2p5_vl_32b_instruct_basic_response_text.apply(lambda x: x.count("The meme views") == 0)
    temp1_df = memes.loc[mask].copy(deep=True)
    temp1_df[["qwen2p5_vl_32b_instruct_response_json", "qwen2p5_vl_32b_instruct_basic_response_text", "retries"]] = temp1_df.p_apply(
    ...
    memes.loc[temp1_df.index, "qwen2p5_vl_32b_instruct_response_json"] = temp1_df["qwen2p5_vl_32b_instruct_response_json"]
    memes.loc[temp1_df.index, "qwen2p5_vl_32b_instruct_basic_response_text"] = temp1_df["qwen2p5_vl_32b_instruct_basic_response_text"]
    memes.to_csv(
