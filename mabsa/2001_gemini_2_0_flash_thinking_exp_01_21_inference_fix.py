...
ParallelPandas.initialize(n_cpu=2)
...
def main():
    ...
    mask = memes.gemini_2_0_flash_thinking_exp_01_21_response_text.apply(lambda x: True if (not isinstance(x, str) or not x.strip() or x.count("The meme views") == 0) else False)
    temp1_df = memes.loc[mask].copy(deep=True)
    temp1_df[["gemini_2_0_flash_thinking_exp_01_21_response_json", "gemini_2_0_flash_thinking_exp_01_21_response_text", "retries"]] = temp1_df.p_apply(
    ...
    memes.loc[temp1_df.index, "gemini_2_0_flash_thinking_exp_01_21_response_json"] = temp1_df["gemini_2_0_flash_thinking_exp_01_21_response_json"]
    memes.loc[temp1_df.index, "gemini_2_0_flash_thinking_exp_01_21_response_text"] = temp1_df["gemini_2_0_flash_thinking_exp_01_21_response_text"]
    memes.to_csv(
