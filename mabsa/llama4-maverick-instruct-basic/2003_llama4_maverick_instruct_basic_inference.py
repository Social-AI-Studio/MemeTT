...
def inference(
    ...
    return llama_response_json, llama_response_text
...
def main():
    ...
    memes[["llama4_maverick_instruct_basic_response_json", "llama4_maverick_instruct_basic_response_text"]] = memes.p_apply(
