...
def main():
    ...
    mask = memes.mistral_small_2503_response_text.apply(lambda x: x.count("The meme views") == 0)
    temp1_df = memes.loc[mask].copy(deep=True)
    temp1_df[["mistral_small_2503_response_json", "mistral_small_2503_response_text", "retries"]] = temp1_df.p_apply(
    ...
    memes.loc[temp1_df.index, "mistral_small_2503_response_json"] = temp1_df["mistral_small_2503_response_json"]
    memes.loc[temp1_df.index, "mistral_small_2503_response_text"] = temp1_df["mistral_small_2503_response_text"]
    memes.to_csv(
