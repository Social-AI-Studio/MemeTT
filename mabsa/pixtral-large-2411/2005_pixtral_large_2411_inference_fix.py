...
def main():
    ...
    mask = memes.pixtral_large_2411_response_text.apply(lambda x: x.count("The meme views") == 0)
    temp1_df = memes.loc[mask].copy(deep=True)
    temp1_df[["pixtral_large_2411_response_json", "pixtral_large_2411_response_text", "retries"]] = temp1_df.p_apply(
    ...
    memes.loc[temp1_df.index, "pixtral_large_2411_response_json"] = temp1_df["pixtral_large_2411_response_json"]
    memes.loc[temp1_df.index, "pixtral_large_2411_response_text"] = temp1_df["pixtral_large_2411_response_text"]
    memes.to_csv(
